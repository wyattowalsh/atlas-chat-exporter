import type { Block, ConversationDoc, ListItem, Role } from "../../shared/src";

export function renderMarkdown(doc: ConversationDoc, options: { includeRoleHeadings: boolean; includeHorizontalRules: boolean }): string {
  const parts: string[] = [];
