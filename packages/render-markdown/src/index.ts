import { type Block, type ConversationDoc, type ListItem } from "@atlas/shared";
...
export function renderMarkdown(document: ConversationDoc, options: MarkdownRenderOptions): string {
